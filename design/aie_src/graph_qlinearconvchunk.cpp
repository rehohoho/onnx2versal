...
const int OUT_W_STRIDE2_3x3 = (OUT_W - K)/2+1;
const int OUT_W_STRIDE2_PAD16_3x3 = (OUT_W_STRIDE2_3x3 + 15)/16*16;
const int W1_STRIDE2 = (INP_W_PAD16+K-1 +15)/16*16 - INP_W_PAD16;
...
std::vector<int32_t> int8bias {0, 166, 333, 500, 666, 833};
...
QLinearConvChunkHGraphTest<SplitInt8, QLinearConvScalarStream, ConcatInt8Stream, HCHUNK, 
                           INP_H, INP_W_PAD16, OUT_W_PAD16, STEP_H, STEP_W, B, C, M, K, 
                           PAD, PAD, PAD, W1> qLinearConvScalarStream(
  "qLinearConvScalarStream", int8bias, 0.004, 0.003, 0.002, 25, 0, 19,
