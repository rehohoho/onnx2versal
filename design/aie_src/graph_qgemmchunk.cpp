...
QgemmChunkNStreamGraphTest<QgemmScalarStream, ConcatInt8Stream, NCHUNK, TT, TTPARAM, M, K, N> qgemmScalar(
  "qgemmScalar", weights, bias, 0.004, 0.003, 0.002, 25, 0, 19,
  "qgemm_int8in.txt", "qgemm_int8out_shape1x30_qgemmScalar.txt");

QgemmChunkNStreamGraphTest<QgemmStream, ConcatInt8Stream, NCHUNK, TT, TTPARAM, M, K, N> qgemmVector(
