...
class QgemmChunkNGraphTest : public adf::graph {

  private:
    QgemmChunkNGraph<QGEMM, CONCAT, NCHUNK, TT, TTPARAM, M, K, N> g;

  public:
    adf::input_plio plin[1];
    adf::output_plio plout[1];

    QgemmChunkNGraphTest(
      const std::string& id,
...
QgemmChunkNGraphTest<QgemmScalar, ConcatInt8Stream, NCHUNK, TT, TTPARAM, M, K, N> qgemmScalar(
  "qgemmScalar", weights, bias, 0.004, 0.003, 0.002, 25, 0, 19,
  "qgemm_int8in.txt", "qgemm_int8out_shape1x30_qgemmScalar.txt");

QgemmChunkNGraphTest<Qgemm, ConcatInt8Stream, NCHUNK, TT, TTPARAM, M, K, N> qgemmVector(
