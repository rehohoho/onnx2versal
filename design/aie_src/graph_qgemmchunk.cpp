...
class QgemmChunkNStreamGraphTest : public adf::graph {
  ...
  private:
    QgemmChunkNStreamGraph<QGEMM, CONCAT, NCHUNK, TT, TTPARAM, M, K, N> g;
...
QgemmChunkNStreamGraphTest<QgemmScalarStream, ConcatInt8, NCHUNK, TT, TTPARAM, M, K, N> qgemmScalar(
  "qgemmScalar", weights, bias, 0.004, 0.003, 0.002, 25, 0, 19,
  "qgemm_int8in.txt", "qgemm_int8out_shape1x30_qgemmScalar.txt");

QgemmChunkNStreamGraphTest<QgemmStream, ConcatInt8, NCHUNK, TT, TTPARAM, M, K, N> qgemmVector(
