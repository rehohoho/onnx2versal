...
ConvReluChunkGraphTest<ConvReluScalarBCHW, 1, mchunk, 28, 24, 1, 2, 2, 5> fpscalar_bchw(
  "fpscalar_bchw", weights, bias, "conv_fpin.txt", "conv_fpout_ConvReluScalarBCHW.txt");
ConvReluChunkGraphTest<ConvReluScalarBCHW, 1, mchunk, 28, 24, 1, 2, 2, 5> fpscalar_bchw_rand(
  "fpscalar_bchw_rand", weights_rand, bias_rand, "conv_fpin_rand.txt", "conv_fpout_ConvReluScalarBCHW_rand.txt");

ConvReluChunkGraphTest<ConvReluScalarBHWC, 0, mchunk, 28, 24, 1, 2, 2, 5> fpscalar_bhwc(
  "fpscalar_bhwc", weights, bias, "conv_fpin.txt", "conv_fpout_ConvReluScalarBHWC.txt");
ConvReluChunkGraphTest<ConvReluScalarBHWC, 0, mchunk, 28, 24, 1, 2, 2, 5> fpscalar_bhwc_rand(
  "fpscalar_bhwc_rand", weights_rand, bias_rand, "conv_fpin_rand.txt", "conv_fpout_ConvReluScalarBHWC_rand.txt");

ConvReluChunkGraphTest<Conv5x5ReluBCHW, 1, mchunk, 28, 24, 1, 2, 2, 5> fpvector_bchw(
  "fpvector_bchw", weights, bias, "conv_fpin.txt", "conv_fpout_Conv5x5ReluBCHW.txt");
ConvReluChunkGraphTest<Conv5x5ReluBCHW, 1, mchunk, 28, 24, 1, 2, 2, 5> fpvector_bchw_rand(
