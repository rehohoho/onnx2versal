...
class PoolGraphTest : public adf::graph {
  ...
  private:
    ...
    PoolGraph<POOL, TT, INP_H, INP_W, OUT_H, OUT_W, B, C, KH, KW, STEP_H, STEP_W, PAD, H0, H1, W0, W1> g;
...
// BCHW
PoolGraphTest<MaxpoolScalarBCHW, float, INP_H, INP_W, OUT_H, OUT_W, B, C, KH, KW, STEP_H, STEP_W, Pad2DStreamFloat,0,0,0,0> maxpoolScalarBCHW(
  "maxpoolScalarBCHW", "pool_fpin.txt", "poolBCHW_max_fpout_shape1x6x12x12_MaxpoolScalarBCHW.txt");
PoolGraphTest<Maxpool2x2FloatBCHW, float, INP_H, INP_W, OUT_H, OUT_W, B, C, KH, KW, STEP_H, STEP_W, Pad2DStreamFloat,0,0,0,0> maxpool2x2BCHW(
  "maxpool2x2BCHW", "pool_fpin.txt", "poolBCHW_max_fpout_shape1x6x12x12_Maxpool2x2FloatBCHW.txt");
PoolGraphTest<AvgpoolScalarBCHW, float, INP_H, INP_W, OUT_H, OUT_W, B, C, KH, KW, STEP_H, STEP_W, Pad2DStreamFloat,0,0,0,0> avgpoolScalarBCHW(
  "avgpoolScalarBCHW", "pool_fpin.txt", "poolBCHW_avg_fpout_shape1x6x12x12_AvgpoolScalarBCHW.txt");

PoolGraphTest<Maxpool2x2Int8BCHW, int8_t, INP_H, INP_W_PAD16, OUT_H, OUT_W_PAD16, B, C, KH, KW, STEP_H, STEP_W, Pad2DStreamInt8,0,0,0,0> maxpool2x2int8BCHW(
  "maxpool2x2int8BCHW", "pool_int8in_pad.txt", "poolBCHW_max_int8out_shape1x6x12x12_Maxpool2x2Int8BCHW.txt");

// BHWC
PoolGraphTest<MaxpoolScalarBHWC, float, INP_H, INP_W, OUT_H, OUT_W, B, C, KH, KW, STEP_H, STEP_W, Pad2DStreamFloat,0,0,0,0> maxpoolScalarBHWC(
