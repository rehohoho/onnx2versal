...
class PoolChunkCGraphTest : public adf::graph {
  ...
  private:
    PoolChunkCGraph<SPLIT, POOL, CONCAT, CCHUNK, TT, INP_H, INP_W, OUT_H, OUT_W, B, C, KH, KW> g;
...
PoolChunkCGraphTest<SplitInt8, Maxpool2x2Int8BCHW, ConcatInt8Stream, 
                    CCHUNK, int8_t, INP_H, INP_W_PAD16, OUT_H, OUT_W_PAD16, B, C, KH, KW> maxpool2x2int8BCHW(
