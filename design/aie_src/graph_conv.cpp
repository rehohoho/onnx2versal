...
ConvReluStreamGraphTest<ConvReluScalarStreamCacheHW, INP_H, INP_W, OUT_W, STEP_H, STEP_W, B, C, M, K, IS_RELU,
  ...
  "conv_fpin.txt", "convbchw_fpout_shape1x4x24x24_ConvReluScalarStreamCacheHW.txt");

ConvReluStreamGraphTest<ConvReluScalarStreamCacheCKK, 
                        INP_H, INP_W, OUT_W, STEP_H, STEP_W, B, C, M, 3, IS_RELU,
                        3/2, 3/2, 3/2, 3/2> convReluScalarStreamCacheCKK(
  "convReluScalarStreamCacheCKK", fpbias, 
  "conv_fpin.txt", "convbchw_3x3_fpout_shape1x4x24x24_ConvReluScalarStreamCacheCKK.txt");

ConvReluStreamGraphTest<Conv3x3ReluStreamCacheCKK, 
                        INP_H, INP_W, OUT_W, STEP_H, STEP_W, B, C, M, 3, IS_RELU,
                        3/2, 3/2, 3/2, (INP_W+K-1 +3)/4*4 - INP_W - 3/2> conv3x3ReluCacheCKK(
...
ConvReluStreamGraphTest<ConvReluScalarStreamCacheHW, INP_H, INP_W, (OUT_W - K)/2+1, 2, 2, 
  ...
  "conv_fpin.txt", "convbchw_fpout_stride2_shape1x4x10x10_ConvReluScalarStreamCacheHW.txt");

ConvReluStreamGraphTest<ConvReluScalarStreamCacheCKK, 
                        INP_H, INP_W, (OUT_W - 3)/2+1, 2, 2, B, C, M, 3, IS_RELU,
                        0, 0, 0, 0> convReluScalarStreamCacheCKK_s2(
  "convReluScalarStreamCacheCKK_s2", fpbias, 
  "conv_fpin.txt", "convbchw_3x3_stride2_fpout_shape1x4x11x11_ConvReluScalarStreamCacheCKK.txt");

ConvReluStreamGraphTest<Conv3x3ReluStreamCacheCKK, 
                        INP_H, INP_W, ((OUT_W - 3)/2+1 + 3)/4*4, 2, 2, B, C, M, 3, IS_RELU,
                        0, 0, 0, 0> conv3x3ReluCacheCKK_s2(
  "conv3x3ReluCacheCKK_s2", fpbias, 
  "conv_fpin.txt", "convbchw_3x3_stride2_fpout_shape1x4x11x11_Conv3x3ReluStreamCacheCKK.txt");


#if defined(__X86SIM__) || defined(__AIESIM__)
int main(int argc, char ** argv) {
  // init gmio
  int fpweights_5x5_size = M*C*K*K * sizeof(float_t);
  float_t* fpweights_5x5_buf = (float_t *) adf::GMIO::malloc(fpweights_5x5_size);
  memcpy(fpweights_5x5_buf, fpweights.data(), fpweights_5x5_size);
  ...
  convReluScalarStreamCacheHW.gmio_w.gm2aie_nb(fpweights_5x5_buf, fpweights_5x5_size);
  ...
  convReluScalarStreamCacheHW_s2.gmio_w.gm2aie_nb(fpweights_5x5_buf, fpweights_5x5_size);
