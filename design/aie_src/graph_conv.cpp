...
ConvReluGraphTest<ConvReluScalarBHWC, INP_H, INP_W, OUT_W, OUT_W_PAD, STEP_H, STEP_W, 
                  B, C, M, KH, KW, GROUP, IS_RELU, PADH, PADH, PADW, PADW> convReluScalarBHWC(
...
ConvReluGraphTest<Conv3x3on12ReluBCHW, INP_H, INP_W, OUT_W, OUT_W_PAD, STEP_H, STEP_W, 
...
ConvReluStreamGraphTest<ConvReluScalarStreamCacheCKK, 
  ...
  "conv_fpin.txt", "convbchw_fpout_3x3_shape1x4x24x24_ConvReluScalarStreamCacheCKK.txt");
