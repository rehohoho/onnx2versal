...
class QLinearPoolChunkCGraphTest : public adf::graph {

  private:
    QLinearPoolChunkCGraph<SPLIT, QLINEARPOOL, CONCAT, CCHUNK,
...
QLinearPoolChunkCGraphTest<SplitInt8, QLinearAvgpoolScalarBCHW, ConcatInt8Stream, 
