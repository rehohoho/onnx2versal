...
if __name__ == "__main__":
  ...
  slave_list = [
    ("plout0_lenet_argm19", f"{args.output_dir}/lenet_out.txt", 64, "float32", 1),
    # first 3
    ("plout1_lenet_conv00", f"{args.output_dir}/lenet_mnist__1___relu1_Relu___relu1_Relu_output_0__1x6x24x24.txt", 64, "float32", 24*24*6),
    ("plout2_lenet_pool01", f"{args.output_dir}/lenet_mnist__2___pool1_MaxPool___pool1_MaxPool_output_0__1x6x12x12.txt", 64, "float32", 12*12*6),
    ("plout3_lenet_conv02", f"{args.output_dir}/lenet_mnist__4___relu2_Relu___relu2_Relu_output_0__1x16x8x8.txt", 64, "float32", 8*8*16),
    # last 3
